...
import { hexToRgb, type Theme } from './engine'
...
export const THEMES: Record<Theme, Record<string, string>> = {
  light: {
    ...
    '--track-sh': 'inset 0 1px 3px rgba(40,70,130,0.10)',
    ...
    '--shell': 'linear-gradient(180deg,#cfe3f7,#eaf2fc)',
  ...
  dark: {
    ...
    '--card-sh-s': 'inset 0 1px 2px rgba(0,0,0,0.35)', '--inset': 'rgba(255,255,255,0.04)',
    ...
    '--track-sh': 'inset 0 1px 3px rgba(0,0,0,0.5)',
    ...
    '--shell': 'linear-gradient(180deg,#0d1420,#0a0f18)',
